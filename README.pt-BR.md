...
📖 **[Documentação Completa](#)** — tipos de step em profundidade, todas as propriedades de configuração, API WebSocket, Dead Letter Queue, decisões de arquitetura e mais.
